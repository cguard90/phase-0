...
//The toughest one was creating the first child, but it didn't give me too too much trouble. I was thrown off by it becuase I initially tried to do it on 2 lines. I then looked at it and just mimiced the existing syntax and hoped it would work and it did.
//    How difficult was it to add and delete properties outside of the object itself? not hard, I had just forgotten that delete comes before the content to be deleted, not after.
//    What did you learn about manipulating objects in this challenge? that node is more user friendly than the last version of JS that I used. I'm happy this went as smoothly as it did. JS normally intimidates me compared to ruby.